"""
Django settings for dockerchangetest_44763 project.
...
ROOT_URLCONF = 'dockerchangetest_44763.urls'
...
WSGI_APPLICATION = 'dockerchangetest_44763.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dockerchangetest_44763 API",
    "DESCRIPTION": "API documentation for dockerchangetest_44763 App",
    "VERSION": "v1",
}
