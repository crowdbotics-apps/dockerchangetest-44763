...
const dockerchangetestAPI = axios.create({
  baseURL: "https://dockerchangetest-44763.botics.co",
  headers: { Accept: "application/json", "Content-Type": "application/json" }
})
function api_docs_schema_retrieve(payload) {
  return dockerchangetestAPI.get(`/api-docs/schema/`, {
    params: { lang: payload.lang }
  })
}
function api_v1_login_create(payload) {
  return dockerchangetestAPI.post(`/api/v1/login/`, payload)
}
function api_v1_signup_create(payload) {
  return dockerchangetestAPI.post(`/api/v1/signup/`, payload)
}
function modules_social_auth_apple_connect_create(payload) {
  return dockerchangetestAPI.post(
    `/modules/social-auth/apple/connect/`,
    payload
  )
}
function modules_social_auth_apple_login_create(payload) {
  return dockerchangetestAPI.post(`/modules/social-auth/apple/login/`, payload)
}
...
function modules_social_auth_google_login_create(payload) {
  return dockerchangetestAPI.post(`/modules/social-auth/google/login/`, payload)
}
function modules_social_auth_socialaccounts_list(payload) {
  return dockerchangetestAPI.get(`/modules/social-auth/socialaccounts/`)
}
...
function rest_auth_login_create(payload) {
  return dockerchangetestAPI.post(`/rest-auth/login/`, payload)
}
function rest_auth_logout_create(payload) {
  return dockerchangetestAPI.post(`/rest-auth/logout/`)
}
function rest_auth_password_change_create(payload) {
  return dockerchangetestAPI.post(`/rest-auth/password/change/`, payload)
}
function rest_auth_password_reset_create(payload) {
  return dockerchangetestAPI.post(`/rest-auth/password/reset/`, payload)
}
function rest_auth_password_reset_confirm_create(payload) {
  return dockerchangetestAPI.post(`/rest-auth/password/reset/confirm/`, payload)
}
function rest_auth_registration_create(payload) {
  return dockerchangetestAPI.post(`/rest-auth/registration/`, payload)
}
...
function rest_auth_user_retrieve(payload) {
  return dockerchangetestAPI.get(`/rest-auth/user/`)
}
function rest_auth_user_update(payload) {
  return dockerchangetestAPI.put(`/rest-auth/user/`, payload)
}
function rest_auth_user_partial_update(payload) {
  return dockerchangetestAPI.patch(`/rest-auth/user/`, payload)
}
